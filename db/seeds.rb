...
Answer.create!([{ question: questions[0], body: 'function' },
                ...
                { question: questions[7], body: 'Pages written in HTML, CSS, JavaScript and is sending by server without any proccesing' },
                ...
                { question: questions[8], body: 'Active Record is M in MVC - model - what is a layer in system, provides busines logic' },
                { question: questions[8], body: 'Records that can actively interract with other application parts' },
                { question: questions[8], body: '@' },
                { question: questions[9], body: '@' },
                { question: questions[9], body: '@' },
                { question: questions[9], body: '@' },
                { question: questions[10], body: '@' },
                { question: questions[10], body: '@' },
                { question: questions[10], body: '@' },
